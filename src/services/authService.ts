...
const DEFAULT_CLIENT_ID = (import.meta.env.VITE_GOOGLE_CLIENT_ID as string) || (firebaseConfig as any).oAuthClientId || '463075236141-sspqgvtjaaakh5gna6alvdahhjl827od.apps.googleusercontent.com';
